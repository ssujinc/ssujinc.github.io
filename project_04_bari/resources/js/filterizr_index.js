        ...
        init: function(selector, options) {
			...
			if(selector == '.filtr-container2'){
				self.options = {
					...
					layout: 'sameSize',
					selector: (typeof selector === 'string') ? selector : '.filtr-container2',
					setupControls: true
				};
			} else if( selector == '.filtr-container'){
				self.options = {
					animationDuration: 0.5,
					callbacks: {
						onFilteringStart: function() { },
				...
				self.options = {
					...
					layout: 'sameSize',
					selector: (typeof selector === 'string') ? selector : '.filtr-container_lunch',
					setupControls: true
				};
			}
